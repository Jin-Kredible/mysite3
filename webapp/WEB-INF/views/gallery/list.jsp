		...
		<div id="content">
			<div id="gallery">
				...
				<c:forEach items="${list }" var="list"> 
						<li>
							<a	href="${pageContext.request.contextPath }/gallery/${list.saveFileName}"
								id="image-background"
								data-lightbox="gallery"
								class="image"
								style="background-image:url('${pageContext.request.contextPath }/gallery/${list.saveFileName}')"
								data-lightbox="${list.saveFileName}" data-title="${list.comments }"> </a>
